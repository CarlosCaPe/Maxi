CREATE PROCEDURE [Corp].[st_getTransactionStatusbyTicket]
(
	@idTicket INT
)
AS 
...
BEGIN 
	...
	BEGIN TRY 
		...
		FROM Tickets WITH(NOLOCK) WHERE IdTicket = @idTicket
	...
	BEGIN CATCH
	    ...
	    INSERT INTO [dbo].[ErrorLogForStoreProcedure] ([StoreProcedure], [ErrorDate], [ErrorMessage]) VALUES ('Corp.st_getTransactionStatusbyTicket', GETDATE(), @ErrorMessage)
	END CATCH
