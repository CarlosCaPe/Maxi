CREATE Procedure [Corp].[st_ReportMSBAgentInformation]  
(  
@Year int  
)  
As  
...
exec [Corp].[st_TotalTransferByMonth] @Year,1;  
...
exec [Corp].[st_TotalTransferByMonth] @Year,2;  
...
exec [Corp].[st_TotalTransferByMonth] @Year,3;  
...
exec [Corp].[st_TotalTransferByMonth] @Year,4;  
...
exec [Corp].[st_TotalTransferByMonth] @Year,5;  
...
exec [Corp].[st_TotalTransferByMonth] @Year,6;  
...
exec [Corp].[st_TotalTransferByMonth] @Year,7;  
...
exec [Corp].[st_TotalTransferByMonth] @Year,8;  
...
exec [Corp].[st_TotalTransferByMonth] @Year,9;  
...
exec [Corp].[st_TotalTransferByMonth] @Year,10;  
...
exec [Corp].[st_TotalTransferByMonth] @Year,11;  
...
exec [Corp].[st_TotalTransferByMonth] @Year,12;  
