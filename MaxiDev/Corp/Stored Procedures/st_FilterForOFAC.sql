CREATE  procedure [Corp].[st_FilterForOFAC]                                
(                                
    @StartDate datetime,                                
    @EndDate datetime,
    @HasError bit output,                  
...
Begin Catch                  
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('Corp.st_FilterForOFAC',Getdate(),@ErrorMessage)                                                      
End Catch  
