CREATE Procedure [Corp].[st_SaveCustomerMirror]
(
    @IdCustomer int
)
as
...
Begin Catch	
	...
	Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('Corp.st_SaveCustomerMirror',Getdate(),@ErrorMessage)                                                
