CREATE procedure [Corp].[st_GetOtherProductProfitV2]
    @From datetime ,
    @hasta datetime ,
...
begin
    insert into @Products
    select IdOtherProduct from [RelationAgentBalanceServiceOtherProduct] with (nolock) where IdAgentBalanceService=@IdAgentBalanceService
end
