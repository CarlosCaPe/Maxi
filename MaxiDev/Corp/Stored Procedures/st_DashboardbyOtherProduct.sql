Create Procedure [Corp].[st_DashboardbyOtherProduct]
(
    @IdOtherProduct int,
    @WeeksAgo int,
...
begin        
    ...
    exec [Corp].[st_DashboardbyOtherProductBP]   @WeeksAgo,@NowWithTime,@Increment,@IdUserSeller,@IdUserRequester,@StatusesPreselected
end

if (@IdOtherProduct=5) or (@IdOtherProduct is null)
begin        
    insert into #DashboardbyOtherProduct
    --exec [Corp].[st_DashboardbyOtherProductLD]   @WeeksAgo,@NowWithTime,@Increment,@IdUserSeller,@IdUserRequester,@StatusesPreselected
    exec [Corp].[st_DashboardbyOtherProductLN]   @IdOtherProduct,@WeeksAgo,@NowWithTime,@Increment,@IdUserSeller,@IdUserRequester,@StatusesPreselected
end

if (@IdOtherProduct=6) or (@IdOtherProduct is null)
begin        
    insert into #DashboardbyOtherProduct
    --exec [Corp].[st_DashboardbyOtherProductTU]   @WeeksAgo,@NowWithTime,@Increment,@IdUserSeller,@IdUserRequester,@StatusesPreselected
    exec [Corp].[st_DashboardbyOtherProductLN]   @IdOtherProduct,@WeeksAgo,@NowWithTime,@Increment,@IdUserSeller,@IdUserRequester,@StatusesPreselected
end
...
begin        
    insert into #DashboardbyOtherProduct
    exec [Corp].[st_DashboardbyOtherProductBBP]   @WeeksAgo,@NowWithTime,@Increment,@IdUserSeller,@IdUserRequester,@StatusesPreselected
end

if (@IdOtherProduct=7) or (@IdOtherProduct is null)
begin        
    insert into #DashboardbyOtherProduct
    exec [Corp].[st_DashboardbyOtherProductTTU]   @WeeksAgo,@NowWithTime,@Increment,@IdUserSeller,@IdUserRequester,@StatusesPreselected
end
