CREATE PROCEDURE [Corp].[st_CancelProductTransferByIdUser_Lunex]
(
    @IdLenguage int,
    @EnterByIdUser int,    
...
Begin Catch                                                                                        
    ...
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('Corp.st_CancelProductTransferByIdUser_Lunex',Getdate(),@ErrorMessage);                                                                                            
End Catch
