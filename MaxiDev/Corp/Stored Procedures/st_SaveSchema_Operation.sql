CREATE PROCEDURE [Corp].[st_SaveSchema_Operation]
(   
    @IdSchema INT,
...
BEGIN CATCH
	...
	INSERT INTO [dbo].[ErrorLogForStoreProcedure] ([StoreProcedure], [ErrorDate], [ErrorMessage]) VALUES ('[Corp].[st_SaveSchema_Operation]', GETDATE(), @ErrorMessage)
END CATCH
