CREATE PROCEDURE [Corp].[st_InsertUpdateCommissions]
(
...
begin catch
	...
	Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('Corp.st_InsertUpdateCommissions',Getdate(),@ErrorMessage);
end catch
