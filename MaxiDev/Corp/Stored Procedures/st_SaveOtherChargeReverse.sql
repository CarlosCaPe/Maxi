CREATE PROCEDURE [Corp].[st_SaveOtherChargeReverse]
(    
...
Begin Catch  
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].[st_SaveOtherChargeReverse]',Getdate(),@ErrorMessage)                                  
End Catch
