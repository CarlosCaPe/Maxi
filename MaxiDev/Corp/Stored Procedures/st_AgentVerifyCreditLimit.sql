CREATE procedure [Corp].[st_AgentVerifyCreditLimit]
(
    @Idagent int
)
as
...
EXEC [Corp].[st_GetAgentCreditApproval] @IdAgent
...
Begin Catch 
 ...
 Insert into [dbo].[ErrorLogForStoreProcedure] (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].st_AgentVerifyCreditLimit',Getdate(),@ErrorMessage)                                                                                            
End Catch 
