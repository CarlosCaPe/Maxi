CREATE procedure [Corp].[st_ReportQuarterTransferByCountry]    
(    
@Year int,     
@Quarter int    
)    
...
Num int,    
Amount money,
Country nvarchar(max) COLLATE SQL_Latin1_General_CP1_CI_AS
);    
...
exec [Corp].[st_TotalTransferByMonthByCountry] @Year, @Month1  ;  
    
Insert into #Results2    
exec [Corp].[st_TotalTransferByMonthByCountry] @Year, @Month2  ;  
    
Insert into #Results3    
exec [Corp].[st_TotalTransferByMonthByCountry] @Year, @Month3  ;  
