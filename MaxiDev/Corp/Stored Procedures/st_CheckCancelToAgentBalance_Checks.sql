CREATE PROCEDURE [Corp].[st_CheckCancelToAgentBalance_Checks]
(
    @IdCheck int,
    @EnterByIdUser int,
    @IsReject bit = null
...
begin
    ...
    select @IdOtherChargesMemo=IdOtherChargesMemo from OtherChargesMemo with(nolock) where memo='4407-03 NSF Fee'
...
--				NULL)
		...
		EXEC [Corp].[st_ApplyDepositMaxicollectionForWeekend] @idagent, @maxicollectiondate, @TotalForCollection
   ...
   --     begin
			...
			--ELSE SET @recipients = 'ecedillo@boz.mx'
