CREATE PROCEDURE [Corp].[st_GetUploadFile]
...
insert into #result1
			...
			left join [Checks] C on C.IdCheck=U.IdReference
			left join [Country] co on d.IdCountry = co.IdCountry
			left join [State] s on d.IdState = s.IdState
