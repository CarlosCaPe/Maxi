CREATE PROCEDURE [Corp].[st_UpdateAgentSchemaDetails_InternalSalesMonitor]
(		
	@IdAgent int,	
	@EnterByIdUser int,
	@XMLExchangeRate xml, 
...
Begin Catch
	...
	Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('Corp.st_UpdateAgentSchemaDetails_InternalSalesMonitor',Getdate(),@ErrorMessage);
End Catch
