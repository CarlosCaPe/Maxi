CREATE PROCEDURE [Corp].[st_GetAgentApplicationStatusHistory]
(
    ...
    FROM [dbo].[AgentApplicationStatusHistory] AS AASH WITH(NOLOCK)
	   ...
	   And
		  (
			 ...
			 OR
			 (@IsSubAccount = 1 AND AASH.IdAgentApplicationStatus NOT IN (21,22,23,26,28))
		  )
...
begin catch
    ...
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('Corp.st_GetAgentApplicationStatusHistory',Getdate(),@ErrorMessage);
End Catch
