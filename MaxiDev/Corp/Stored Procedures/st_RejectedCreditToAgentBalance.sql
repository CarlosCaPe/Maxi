CREATE PROCEDURE [Corp].[st_RejectedCreditToAgentBalance]             
...
Select @ErrorMessage=ERROR_MESSAGE()                                                        
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].[st_RejectedCreditToAgentBalance]',Getdate(),@ErrorMessage)                                                                                            
end catch
