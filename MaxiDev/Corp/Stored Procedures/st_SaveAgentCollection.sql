CREATE PROCEDURE [Corp].[st_SaveAgentCollection]
(
...
SELECT @IdAgentCollection=IdAgentCollection FROM AgentCollection WITH(NOLOCK) WHERE IdAgent=@IdAgent
...
BEGIN CATCH
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].[st_SaveAgentCollection]',Getdate(),@ErrorMessage)    
END CATCH
