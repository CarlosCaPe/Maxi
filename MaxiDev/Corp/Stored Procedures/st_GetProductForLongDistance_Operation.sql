CREATE PROCEDURE [Corp].[st_GetProductForLongDistance_Operation]
	@IdProvider INT
AS
/********************************************************************
<Author> ??? </Author>
...
begin catch
    ...
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].[st_GetProductForLongDistance_Operation]',Getdate(),@ErrorMessage);
End Catch
