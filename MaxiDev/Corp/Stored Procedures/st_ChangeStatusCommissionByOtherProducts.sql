CREATE PROCEDURE [Corp].[st_ChangeStatusCommissionByOtherProducts]
(
...
Begin Catch 
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('Corp.st_ChangeStatusCommissionByOtherProducts',Getdate(),ERROR_MESSAGE())    
End Catch
