CREATE PROCEDURE [Corp].[st_GetDaysToUserSuspended]
@IdUser int 
AS
/********************************************************************
...
END TRY
BEGIN CATCH    
	INSERT INTO ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage) VALUES ('Corp.st_GetDaysToUserSuspended', GETDATE(), ERROR_MESSAGE())
END CATCH
