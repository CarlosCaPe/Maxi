CREATE Procedure [Corp].[st_GetAgentAllCollectionForAssign]
...
from maxicollection with(nolock) where DateOfCollection >= @CollectionDate AND DateOfCollection < dateadd(day,1,@CollectionDate)
--UNION ALL
--Obtener Depositos
...
SELECT c.IdAgent,0 AmountByCalendar,0 AmountByLastDay,AmountExpected AmountByCollectPlan,d.AmountToPay collectAmount,5 idagentcollecttype FROM dbo.AgentCollectionDetail d with(nolock)
