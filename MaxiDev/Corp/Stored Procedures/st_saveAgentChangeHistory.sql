CREATE PROCEDURE [Corp].[st_saveAgentChangeHistory]
	@idAgent INT,
...
BEGIN
	...
	*********************************************************************/
	...
	BEGIN CATCH
		...
		Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].[st_saveAgentChangeHistory]',Getdate(),@ErrorMessage)
	END CATCH
END
