CREATE PROCEDURE [Corp].[st_InsertZipCode]
(
     @ZipCode int
    ,@IdState int
...
begin catch
    ...
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].[st_InsertZipCode]',Getdate(),@ErrorMessage)
end catch
