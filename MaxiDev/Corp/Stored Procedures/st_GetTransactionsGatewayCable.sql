CREATE PROCEDURE [Corp].[st_GetTransactionsGatewayCable]
AS  
...
Begin Catch
    ...
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('Corp.st_GetTransactionsGatewayCable',Getdate(),@ErrorMessage);
End catch
