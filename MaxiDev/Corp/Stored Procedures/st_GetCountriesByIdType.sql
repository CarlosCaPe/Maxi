...
CREATE PROCEDURE [Corp].[st_GetCountriesByIdType] 
AS
BEGIN
  ...
  begin catch	  
	   ...
	   Insert into [Maxi].dbo.ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].[st_GetCountriesByIdType]',Getdate(), @ErrorMessage);
  End Catch
