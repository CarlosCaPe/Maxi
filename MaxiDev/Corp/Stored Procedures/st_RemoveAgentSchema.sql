CREATE PROCEDURE [Corp].[st_RemoveAgentSchema]
(
    @IdAgentSchema int,
    @IdLenguage int,
    @EnterByIdUser int,
...
Begin Catch
	...
	Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].[st_RemoveAgentSchema]',Getdate(),@ErrorMessage)
End Catch
