CREATE PROCEDURE [Corp].[st_InsertUpdateUsersAditionalInfoChangePassword]
	@IdUser int 
AS
/********************************************************************
...
END TRY
BEGIN CATCH    
	INSERT INTO ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage) VALUES ('Corp.st_InsertUpdateUsersAditionalInfoChangePassword', GETDATE(), ERROR_MESSAGE())
END CATCH
