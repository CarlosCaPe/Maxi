CREATE PROCEDURE [Corp].[st_GetAgentBusinessTypesByAgentCode]
(
...
BEGIN CATCH
    ...
    INSERT INTO ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage) VALUES ('Corp.st_GetAgentBusinessTypesByAgentCode', GETDATE(), @ErrorMessage)   
END CATCH
