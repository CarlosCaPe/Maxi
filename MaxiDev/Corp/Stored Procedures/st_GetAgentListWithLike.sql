CREATE PROCEDURE [Corp].[st_GetAgentListWithLike]
(
...
<log Date="15/09/2022" Author="cagarcia">Se agrega IdAgentBankAccount</log>
</ChangeLog>
*********************************************************************/
Begin try
...
Begin Catch
	   ...
	   Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].[st_GetAgentListWithLike]',Getdate(),@ErrorMessage);
