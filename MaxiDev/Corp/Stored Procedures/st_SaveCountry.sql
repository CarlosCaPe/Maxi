CREATE PROCEDURE [Corp].[st_SaveCountry]
(
	@IdCountry INT,
...
BEGIN 
	...
	BEGIN CATCH 
		...
		Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('Corp.st_SaveCountry',Getdate(), CONCAT(ERROR_MESSAGE(),' on line: ', ERROR_LINE()) )   
	END CATCH
END
