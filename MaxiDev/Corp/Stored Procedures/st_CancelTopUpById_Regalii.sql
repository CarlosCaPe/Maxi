CREATE PROCEDURE [Corp].[st_CancelTopUpById_Regalii]
...
Begin Catch                                                                                        
    ...
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].[st_CancelTopUpById_Regalii]',Getdate(),@ErrorMessage)                                                                                            
End Catch
