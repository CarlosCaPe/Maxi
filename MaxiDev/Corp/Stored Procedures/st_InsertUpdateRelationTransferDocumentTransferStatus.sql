CREATE PROCEDURE [Corp].[st_InsertUpdateRelationTransferDocumentTransferStatus]
(
	@IdTransfer INT, 
...
BEGIN CATCH
	...
	INSERT INTO dbo.ErrorLogForStoreProcedure(StoreProcedure, ErrorDate, ErrorMessage) VALUES('Corp.st_InsertUpdateRelationTransferDocumentTransferStatus', GETDATE(), @ErrorMessage)
END CATCH
