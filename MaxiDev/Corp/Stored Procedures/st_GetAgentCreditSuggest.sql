CREATE PROCEDURE [Corp].[st_GetAgentCreditSuggest]
as
/********************************************************************
<Author></Author>
<app></app>
...
begin catch
    ...
    Insert into [Maxi_log].Soporte.InfoLogForStoreProcedure (StoreProcedure,InfoDate,InfoMessage)Values('[Corp].[st_GetAgentCreditSuggest]',Getdate(),@ErrorMessage);
End Catch
