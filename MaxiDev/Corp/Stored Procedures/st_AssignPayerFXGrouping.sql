CREATE PROCEDURE [Corp].[st_AssignPayerFXGrouping]
(
    @IdUser INT,
    @PayerGrouping XML,
    @HasError BIT OUT,
...
BEGIN CATCH
    ...
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].[st_AssignPayerFXGrouping]',Getdate(),@ErrorMessage);
END CATCH
