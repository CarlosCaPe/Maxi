CREATE PROCEDURE [Corp].[st_ValidateAttemptsAndUpdateUserToSuspended]
	@IdUser int 
AS
/********************************************************************
...
END TRY
BEGIN CATCH    
	INSERT INTO ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage) VALUES ('Corp.st_ValidateAttemptsAndUpdateUserToSuspended', GETDATE(), ERROR_MESSAGE())
END CATCH
