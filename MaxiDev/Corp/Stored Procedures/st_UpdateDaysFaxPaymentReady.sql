...
-- =============================================
CREATE PROCEDURE [Corp].[st_UpdateDaysFaxPaymentReady]
...
BEGIN CATCH
	 ...
	 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].[st_UpdateDaysFaxPaymentReady]', Getdate(),@ResultMessage)    
END CATCH
