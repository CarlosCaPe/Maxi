CREATE PROCEDURE [Corp].[st_SaveDenyListCustomer]
(    
...
Begin Catch    
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].[st_SaveDenyListCustomer]',Getdate(),@ErrorMessage)    
End Catch
