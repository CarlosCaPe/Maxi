CREATE Procedure [Corp].[st_GetAgentSchemaDetails_InternalSalesMonitor]
(  
    @IdAgent int,
    @IdLenguage int = null   
)  
...
Begin Catch	
	...
	Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].[st_GetAgentSchemaDetails_InternalSalesMonitor]',Getdate(),@ErrorMessage);
End Catch
