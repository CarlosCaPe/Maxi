CREATE PROCEDURE [Corp].[st_FindCustomerBlackList]
(
...
from 
    customerblacklist c with(nolock)
join 
    customerblacklistrule r with(nolock) on c.IdCustomerBlackListRule=r.IdCustomerBlackListRule
join
