CREATE PROCEDURE [Corp].[st_DashboardWithFilter]
(
    @WeeksAgo int,
...
BEGIN
	...
	BEGIN CATCH
		...
		INSERT INTO dbo.ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].[st_DashboardWithFilter]',Getdate(),'ErrorLine:'+@ErrorLine+',ErrorMessage:'+@ErrorMessage);
