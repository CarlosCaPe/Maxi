CREATE PROCEDURE [Corp].[st_BulkApproveAgentCredit]
(
...
BEGIN CATCH
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('Corp.st_BulkApproveAgentCredit',Getdate(),@ErrorMessage)    
END CATCH
