CREATE PROCEDURE [Corp].[st_SaveGatewayReturnCode]
...
Begin Catch
		 ...
		 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].[st_SaveGatewayReturnCode]',Getdate(),@ErrorMessage) 
		set @HasError =1
