CREATE procedure [Corp].[st_CancelBPTransaction_BillPayment]
(
...
join 
    Billpayment.TransferR t with (nolock) on p.IdProductTransfer=t.IdProductTransfer
where 
...
begin
    ...
    return
            ...
            --Afectar Balance         
             ...
             EXEC	[Corp].[st_AgentBalance_BillPayment]
