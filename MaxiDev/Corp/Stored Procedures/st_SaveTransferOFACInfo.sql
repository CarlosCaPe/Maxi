CREATE PROCEDURE [Corp].[st_SaveTransferOFACInfo]
(
    @IdTransfer int,    
...
BEGIN
    ...
    begin
        set @BeneficiaryPercentMatch = 95
    end
...
Begin Catch                                                                                            
    ...
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('Corp.st_SaveTransferOFACInfo',Getdate(),@ErrorMessage)                                                                                            
End Catch 
