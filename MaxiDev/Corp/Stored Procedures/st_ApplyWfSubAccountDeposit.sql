CREATE PROCEDURE [Corp].[st_ApplyWfSubAccountDeposit]
(
    @DepositData XML,
    @IdUser INT,
...
BEGIN CATCH
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('Corp.st_ApplyWfSubAccountDeposit',Getdate(),@ErrorMessage)    
END CATCH
