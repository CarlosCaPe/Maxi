CREATE PROCEDURE [Corp].[st_GetAgentApplicationBasicInformationById]
(
...
begin catch
    ...
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('Corp.st_GetAgentApplicationBasicInformationById',Getdate(),@ErrorMessage);
End Catch
