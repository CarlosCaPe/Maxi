CREATE PROCEDURE [Corp].[st_SaveQueryOfacForChecks_Checks]
...
BEGIN CATCH
	...
	INSERT INTO [dbo].[ErrorLogForStoreProcedure] ([StoreProcedure], [ErrorDate], [ErrorMessage]) VALUES ('Corp.st_SaveQueryOfacForChecks_Checks', GETDATE(), @ErrorMessage)
END CATCH
