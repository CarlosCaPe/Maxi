CREATE PROCEDURE [Corp].[st_DeleteGroup_Collection]
@idGroups int 
...
Begin Catch
	...
	Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('Corp.st_DeleteGroup_Collection',Getdate(),@ErrorMessage);
End Catch
