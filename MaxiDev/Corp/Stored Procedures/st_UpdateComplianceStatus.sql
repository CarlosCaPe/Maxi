CREATE PROCEDURE [Corp].[st_UpdateComplianceStatus]
 (                  
 @EnterByIdUser int,                  
...
Begin
	...
	exec [Corp].[st_UpdateVerifyHold] @EnterByIdUser, @IsSpanishLanguage, @IdTransfer, @Note, @StatusHold, @IsRelease,
...
Begin
	 ...
	 Begin          
		...
		Exec [Corp].[st_DismissComplianceNotificationByIdTransfer] @IdTransfer, @IsSpanishLanguage, @HasError out, @Message out  
...
Begin Catch                                      
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].[st_UpdateComplianceStatus]',Getdate(),@ErrorMessage)                                      
End Catch
