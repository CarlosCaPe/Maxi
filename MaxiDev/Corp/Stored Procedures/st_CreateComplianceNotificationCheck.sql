CREATE PROCEDURE [Corp].[st_CreateComplianceNotificationCheck]
( 
	@IdCheck INT,
	@IdUser INT,
	@Note NVARCHAR(MAX),
...
BEGIN CATCH
	 ...
	 INSERT INTO ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage) VALUES ('Corp.st_CreateComplianceNotificationCheck',GETDATE(),@ErrorMessage) 
END CATCH
