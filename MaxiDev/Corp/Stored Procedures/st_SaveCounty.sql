CREATE PROCEDURE [Corp].[st_SaveCounty]
(
    @IdCounty int,     
    @IdState int,
...
begin catch
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[Corp].[st_SaveCounty]',Getdate(),@ErrorMessage)
end catch
