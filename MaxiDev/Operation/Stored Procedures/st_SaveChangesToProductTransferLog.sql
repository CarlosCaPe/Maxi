CREATE  Procedure [Operation].[st_SaveChangesToProductTransferLog]          
(          
...
Begin Catch                  
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('operation.st_SaveChangesToProductTransferLog',Getdate(),@ErrorMessage);                  
End Catch  
