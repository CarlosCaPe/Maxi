...
-- Description:	Obtener informacion de Egift
-- =============================================
CREATE PROCEDURE [Operation].[st_GetReportEgift]
(
...
select @Tot=count(1) from operation.ProductTransfer t
...
where t.IdOtherProduct = 11
	...
	and t.IdProductTransfer in (select IdProductTransfer from lunex.transferln where Phone like '%'+isnull(@CellPhone,'')+'%')
