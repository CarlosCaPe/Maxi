CREATE PROCEDURE [Operation].[st_GetUSAUnlimitedInfo]
(
		 @IdLanguaje INT = 1
		,@IdAgent INT = NULL
...
select pt.IdProductTransfer,pt.DateOfCreation,dbo.[fnFormatPhoneNumber](Phone) Phone,pt.amount,pt.transactionproviderid
...
WHERE PT.IdProvider = 3/*lunex*/
		and PT.IdOtherProduct IN (13,16)
        ...
        and ln.phone like '%'+isnull(@BenPhone,ln.phone)+'%'
...
Begin Catch
	...
	Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)VALUES('st_GetUSAUnlimitedInfo',Getdate(),@ErrorMessage)                                                                                            
End Catch  
