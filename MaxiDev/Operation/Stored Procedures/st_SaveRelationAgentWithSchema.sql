...
-- =============================================
CREATE PROCEDURE [Operation].[st_SaveRelationAgentWithSchema]
    @IdAgent INT,
    @IdProvider INT = NULL,
    @Schemas XML,
    @EnterByIdUser INT,
...
BEGIN CATCH
    ...
    INSERT INTO [dbo].[ErrorLogForStoreProcedure] ([StoreProcedure], [ErrorDate], [ErrorMessage]) VALUES ('TransFerTo.st_SaveRelationAgentWithSchemas', GETDATE(),@ErrorMessage)
END CATCH
