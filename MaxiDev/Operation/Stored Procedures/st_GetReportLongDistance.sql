CREATE PROCEDURE [Operation].[st_GetReportLongDistance]
(
    @DateFrom datetime,
    @DateTo datetime,
    @IdProvider int = null,
...
*********************************************************************/
       ...
       BEGIN 
              ...
              FROM operation.producttransfer t WITH(NOLOCK)
                     ...
                     JOIN status PS ON ps.Idstatus=t.idstatus
              WHERE 
                     t.idotherproduct = 5 
                     AND t.idstatus != 1
                     AND t.amount > 0
              ...
              BEGIN
                     INSERT INTO #Result 
                           ...
                           FROM operation.producttransfer t WITH(NOLOCK)
                                  ...
                                  LEFT JOIN Users u2 WITH(NOLOCK) ON u2.IdUser= t.enterbyidusercancel
                                  JOIN status PS ON ps.idstatus=t.idstatus
                                  JOIN pureminutestransaction pm ON pm.Idproducttransfer=t.Idproducttransfer
                                  JOIN providers p ON t.idprovider=p.idprovider
                           WHERE 
                                  t.idotherproduct=5 
              ...
              BEGIN
				...
				INSERT INTO #Result
                           ...
                           FROM operation.producttransfer t WITH(NOLOCK)
                                  ...
                                  LEFT JOIN Users u2 WITH(NOLOCK) ON u2.IdUser= t.enterbyidusercancel
                                  JOIN status PS ON ps.idstatus=t.idstatus
                                  JOIN pureminutestransaction pm ON pm.Idproducttransfer=t.Idproducttransfer and pm.ReceiveAccountNumber like '%'+@CellPhoneWithFormat+'%'
                                  JOIN providers p ON t.idprovider=p.idprovider
                           WHERE 
                                  t.idotherproduct = 5 
                                  --and (t.DateOfCreation>=@DateFrom and t.DateOfCreation<@DateTo) 
				...
				BEGIN
				    ...
				    INSERT INTO #Result
						 ...
						 FROM operation.producttransfer t WITH(NOLOCK)
							   ...
							   LEFT JOIN Users u2 WITH(NOLOCK) ON u2.IdUser = t.enterbyidusercancel
							   JOIN status PS ON ps.idstatus = t.idstatus
							   JOIN lunex.transferln pm ON pm.Idproducttransfer = t.Idproducttransfer and pm.Phone like '%'+@CellPhone+'%'
							   JOIN providers p ON t.idprovider = p.idprovider
