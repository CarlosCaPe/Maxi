CREATE PROCEDURE [Operation].[st_GetTopUpPreTransferReceiptLabels]
(
	@IdTransfer INT
)
AS
...
<Author></Author>
<app>MaxiAgent</app>
<Description>This stored is used to get labels for pretransfer thermal ticket TopUp</Description>
...
*********************************************************************/
BEGIN
	DECLARE @ReceiptPrefix VARCHAR(200) = 'PreReceipt.TU.'
