CREATE PROCEDURE [Regalii].[st_CancelBPTransaction]
(
...
Begin Catch
    ...
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('Regalii.st_CancelBPTransaction',Getdate(),@ErrorMessage)
End Catch
