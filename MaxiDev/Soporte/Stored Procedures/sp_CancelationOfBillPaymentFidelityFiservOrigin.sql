CREATE PROCEDURE [Soporte].[sp_CancelationOfBillPaymentFidelityFiservOrigin]
...
BEGIN
	...
	begin
		...
		select * from [dbo].[AgentBalance] with(nolock) where TypeOfMovement='FBP' and IdTransfer=@ProductTransfer
