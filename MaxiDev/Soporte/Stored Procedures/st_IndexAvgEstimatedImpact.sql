CREATE PROCEDURE [Soporte].[st_IndexAvgEstimatedImpact]
AS
...
<Description>Proceso de notificaciones de indices faltantes en base a estadisticas</Description>
...
BEGIN
	...
	SET @TableHTML = '<table><thead><tr><th>DatabaseID</th><th>Avg_Estimated_Impact</th><th>Last_User_Seek</th><th>PathTableName</th><th>TableName</th><th>Create_Statement</th></tr></thead><tbody>';
	...
	IF OBJECT_ID('tempdb..#TopTable') IS NOT NULL DROP TABLE #TopTable
	...
	SELECT @QueryTableHTML = CAST((
		...
		@subject='Index Avg_Estimated_Impact',
		@body=@TableHTML,
		@body_format = 'HTML'
END