...
-- =============================================
CREATE PROCEDURE [Checks].[st_InsertDenyListIssuerChecks]
...
BEGIN CATCH
	...
	INSERT INTO [dbo].[ErrorLogForStoreProcedure] ([StoreProcedure], [ErrorDate], [ErrorMessage]) VALUES('[Checks].[st_InsertDenyListIssuerChecks]', GETDATE(), @ErrorMessage)
END CATCH