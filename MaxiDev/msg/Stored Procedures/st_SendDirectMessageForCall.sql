CREATE Procedure [msg].[st_SendDirectMessageForCall]
(
    @IdAgent int,
...
begin try
    ...
    begin
        ...
        select top 1  @IdCallStatus=IdCallStatus from callhistory h
...
BEGIN CATCH
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('msg.st_SendDirectMessageForCall',Getdate(),@ErrorMessage)    
END CATCH
