CREATE PROCEDURE [ExRateService].[st_DisableExRateSchedule]
(
...
Begin Catch  
   ...
   Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('ExRateService.st_DisableExRateSchedule',Getdate(),@ErrorMessage)   
   set @HasError =1    
