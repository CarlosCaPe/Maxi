...
create Procedure [BillPayment].[st_AgentBalance]        
(        
    @IdTransaction int,
    @IdOtherProduct int,
    @IdAgent int,
...
begin catch
    ...
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('BillPayment.st_AgentBalance',Getdate(),@ErrorMessage)                                                                                            
end catch
