CREATE PROCEDURE [BillPayment].[st_GetBillPaymentCancelReceiptLabels]
(
	@IdTransfer INT
)
AS
...
<Author></Author>
<app>MaxiAgent</app>
<Description>This stored is used to get labels for cancel thermal ticket BillPayment</Description>

<ChangeLog>
	<log Date="27/12/2022" Author="maprado">Se crea Sp</log>
</ChangeLog>
*********************************************************************/
BEGIN
	DECLARE @ReceiptPrefix VARCHAR(200) = 'CancelReceipt.BP.'
