CREATE PROCEDURE [BillPayment].[st_GetBillPaymentPreTransferReceiptLabels]
AS
/********************************************************************
<Author>MAPRADO</Author>
<app>MaxiAgent</app>
<Description>This stored is used to get labels for pretransfer thermal ticket for BillPayment</Description>

<ChangeLog>
</ChangeLog>
*********************************************************************/
BEGIN
	DECLARE @ReceiptPrefix VARCHAR(200) = 'PreReceipt.BP.'
