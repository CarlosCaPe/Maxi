create procedure [TransFerTo].[st_CancelTransferTToByIdUser2]
(
    @IdLenguage int,
    @EnterByIdUser int,    
...
declare 
    ...
    where 
        IdProductTransfer=@IdProductTransfer /*and [action]=@Action*/ and idstatus=21 and IdOtherProduct=@IdOtherProduct
