CREATE PROCEDURE [InternalSalesMonitor].[st_UpdateCallHistory]
(
	@IdCallHistory	int,
	@IdAgent	int,
	@IdTaskStatus	int,
...
Begin Catch
	...
	Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('InternalSalesMonitor.st_UpdateCallHistory',Getdate(),@ErrorMessage);
End Catch
