CREATE TABLE [dbo].[Option] (
    ...
    CONSTRAINT [PK_Option] PRIMARY KEY CLUSTERED ([IdOption] ASC) WITH (FILLFACTOR = 90),
    CONSTRAINT [FK_Option_Modulo] FOREIGN KEY ([IdModule]) REFERENCES [dbo].[Modulo] ([IdModule])
);
