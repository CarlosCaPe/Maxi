CREATE function  [dbo].[funPayInfoGetAddress] (@IdCity int, @BranchReceive nvarchar(max), @Idgateway int, @IdPayer int, @idstatus int)  
...
declare @AddressReceive nvarchar(max) 
