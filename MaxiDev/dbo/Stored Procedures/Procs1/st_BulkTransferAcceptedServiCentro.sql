CREATE procedure [dbo].[st_BulkTransferAcceptedServiCentro]        
(      
    @IdFile int,
...
Select A.IdTransfer,ClaimCode,b.idstatus into #Temp from [MAXILOG].[dbo].ServiCentroLogFileTXT A with(nolock)      
...
Begin      
 ...
 if  (@Idstatus  = 21) 
 begin        
	Insert into [MAXILOG].dbo.ServiCentroResponseLog values (getdate(),@Claimcode,'None','1',40,@MessageTransfer,'');                      
