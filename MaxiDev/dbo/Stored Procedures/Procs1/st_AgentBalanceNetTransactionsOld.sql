CREATE procedure [dbo].[st_AgentBalanceNetTransactionsOld]
(
    @IdAgent int,
    @DateFrom datetime,
    @DateTo datetime
...
<ChangeLog>
<log Date="19/02/2018" Author="snevarez">Ticket 925: Numero negativo en reporte(AgentBalanceOld.rdl -> DataSet : NetTransaction)</log>
