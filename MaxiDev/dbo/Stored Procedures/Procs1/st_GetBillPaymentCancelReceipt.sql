CREATE procedure [dbo].[st_GetBillPaymentCancelReceipt] 
@Id int
as
...
declare @ReceiptBillPaymentCancelEnglishMessage varchar(max)      
set @ReceiptBillPaymentCancelEnglishMessage = dbo.GetGlobalAttributeByName('ReceiptBillPaymentCancelEnglishMessage');   

declare @ReceiptBillPaymentCancelSpanishMessage varchar(max)      
set @ReceiptBillPaymentCancelSpanishMessage = dbo.GetGlobalAttributeByName('ReceiptBillPaymentCancelSpanishMessage');   
  
  
Select       
  @CorporationPhone CorporationPhone,      
  @CorporationName CorporationName,     
  @ReceiptBillPaymentCancelEnglishMessage ReceiptBillPaymentCancelEnglishMessage,
  @ReceiptBillPaymentCancelSpanishMessage ReceiptBillPaymentCancelSpanishMessage,  
