...
CREATE procedure [dbo].[st_FindCustomerLight_4]
@name varchar(40),
...
declare @customerPivot table (IdCustomer INT,IdAgentCreatedBy INT )


DECLARE @SQL NVARCHAR(max)

SET  @SQL=N'insert into @customerPivot SELECT [C].[IdCustomer],IdAgentCreatedBy '
...
EXECUTE sp_executesql @SQL,N'@idAgent int,@nameT nvarchar(40),@firstLastNameT nvarchar(40), @secondLastNameT nvarchar(40),@cellularT nvarchar (15),@phoneT nvarchar(15)', @customerPivot = @customerPivot OUTPUT , @idAgent=@idAgent,@nameT = @nameT,@firstLastNameT=@firstLastNameT,@secondLastNameT=@secondLastNameT,@cellularT=@cellularT,@phoneT=@phoneT
