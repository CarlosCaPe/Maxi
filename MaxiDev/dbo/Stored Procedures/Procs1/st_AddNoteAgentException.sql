CREATE Procedure [dbo].[st_AddNoteAgentException]
(
 @IdLenguage int,
 @IdAgent Int,
 @Exception bit,
...
Begin Catch
	 ...
	 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_AddNoteAgentException',Getdate(),@ErrorMessage);
End Catch
