CREATE PROCEDURE [dbo].[st_GetDocumentTypesById]
(
	@IdType int
)
as
...
Begin Catch
	 ...
	 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_GetDocumentTypesById',Getdate(),@ErrorMessage);
End Catch 
