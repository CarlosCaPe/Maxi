...
create procedure [dbo].[st_GetBancoUnionCancels]
(            
...
Select   top 1 1            
From Transfer A                          
Where IdGateway=30 and IdStatus=25             
)        
Begin        
...
Select IdTransfer,@FileName,GETDATE(),'Cancel' from transfer Where IdGateway=30 and IdStatus=25
...
' ' AS TelefonoRemitente,  --Teléfono 2 del remitente
a.CustomerIdCustomerIdentificationType AS  TipoIdentificacionRemitente,--Tipo de la identificación del Remitente
a.BeneficiaryIdentificationNumber AS  NumeroIdentificacionRemitente,-- Numero de identificación del Remitente
...
' ' AS TelefonoBeneficiario2,-- Teléfono 2 del Beneficiario
