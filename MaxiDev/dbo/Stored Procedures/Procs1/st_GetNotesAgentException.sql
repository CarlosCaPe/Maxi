...
CREATE PROCEDURE [dbo].[st_GetNotesAgentException]
(
	@IdAgent int
...
Begin Catch
	 ...
	 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_GetNotesAgentException',Getdate(),@ErrorMessage);
End Catch 
