CREATE PROCEDURE [dbo].[st_ApplyScannerDeposit]
(
    @DepositData XML,
    @IdUser INT,
...
BEGIN CATCH
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_ApplyScannerDeposit',Getdate(),@ErrorMessage)    
END CATCH
