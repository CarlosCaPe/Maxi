create PROCEDURE st_ApplyNotEncondeDeposit
(
    @DepositData XML,
    @IdUser INT,
...
BEGIN CATCH
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_SaveEncondeDeposit',Getdate(),@ErrorMessage)    
END CATCH
