CREATE PROCEDURE [dbo].[st_getComplianceProducts]
(
    @IdStatus int
	,@IdTransfer int = NULL
)
...
Begin catch
    ...
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('dbo.st_getComplianceProducts',Getdate(),@ErrorMessage);
End catch
