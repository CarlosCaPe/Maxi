...
CREATE procedure [dbo].[st_AddNoteToCallHistory]
(
     @IdAgent [int],
     @IdUser int,
     @IdCallStatus int,     
...
BEGIN CATCH
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_AddNoteToCallHistory',Getdate(),@ErrorMessage)    
END CATCH
