...
-- Create date: 31/Ene/2017
-- Description:	Actualiza mensajes exsistentes y regresa la cantidad actualizada
-- =============================================
CREATE PROCEDURE st_GetMessagesExisting
(
	@IdAgent INT,
...
BEGIN
	...
	BEGIN CATCH
		 ...
		 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_GetMessagesExisted',Getdate(),@ErrorMessage);
	END CATCH
