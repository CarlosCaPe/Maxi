CREATE PROCEDURE [dbo].[st_AddNoteToTransfer]            
(            
 @IdTransfer Int,            
 @IdUser int,            
 @Note nvarchar(max),            
...
Begin Catch                                                
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[st_AddNoteToTransfer]',Getdate(),@ErrorMessage);                                                
End Catch 
