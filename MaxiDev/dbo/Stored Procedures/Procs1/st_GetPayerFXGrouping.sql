CREATE Procedure [dbo].[st_GetPayerFXGrouping]
(
...
BEGIN CATCH
    ...
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_GetPayerFXGrouping',Getdate(),@ErrorMessage);
END CATCH
