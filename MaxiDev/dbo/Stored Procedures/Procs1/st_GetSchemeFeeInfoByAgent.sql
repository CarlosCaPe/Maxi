...
-- Description:	Get Schemes assigned by agent
-- =============================================
CREATE PROCEDURE [dbo].[st_GetSchemeFeeInfoByAgent]
...
BEGIN
	...
	WHERE [AS].[IdAgent] = @IdAgent AND [AS].[IdGenericStatus] = 1 AND [PC].IdGenericStatus = 1 AND [P].[IdGenericStatus] = 1
