CREATE PROCEDURE [dbo].[st_AgentToSendReportSignatureHold]
(
	@IdAgent int = null
)
AS  
...
Begin Catch    
    ...
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_AgentToSendReportSignatureHold',Getdate(),@ErrorMessage);
End catch
