/********************************************************************
<Author>jzuniga</Author>
<app>??</app>
<Description>??</Description>

<ChangeLog>
<log Date="24/07/2019" Author="jzuniga"> Creado </log>
</ChangeLog>

*********************************************************************/
CREATE procedure [dbo].[st_GetRefexRatesActive]
(
...
Begin Catch
    ...
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_GetRefexRatesActive',Getdate(),@ErrorMessage);
End catch
