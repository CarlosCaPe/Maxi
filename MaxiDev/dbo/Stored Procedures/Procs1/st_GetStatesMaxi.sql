...
-- Description:	This stored get the states of the maxi
-- =============================================
CREATE PROCEDURE [dbo].[st_GetStatesMaxi]
AS
...
Begin Catch
	...
	Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)VALUES('st_GetStateMaxi',Getdate(),@ErrorMessage)                                                                                            
End Catch  
