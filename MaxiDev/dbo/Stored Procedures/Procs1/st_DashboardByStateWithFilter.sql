CREATE Procedure [dbo].[st_DashboardByStateWithFilter]
(
    @WeeksAgo int,
...
BEGIN
	...
	BEGIN CATCH
		...
		INSERT INTO dbo.ErrorLogForStoreProcedure(StoreProcedure, ErrorDate, ErrorMessage) VALUES('dbo.st_DashboardByStateWithFilter', GETDATE(), @Message)
	END CATCH
END
