...
CREATE PROCEDURE [dbo].[st_DismissComplianceNotificationByIdCheck]
(
@IdCheck INT, 
...
BEGIN TRY
	...
	BEGIN
		...
		EXEC [dbo].st_DismissComplianceNotificationCheck @CurrentIdMessage, @IsSpanishLanguage, @CurrentHasError out, @CurrertErrorMessage out
...
BEGIN CATCH
	...
	INSERT INTO dbo.ErrorLogForStoreProcedure(StoreProcedure, ErrorDate, ErrorMessage) VALUES('st_DismissComplianceNotificationByIdCheck', GETDATE(), @MessageError)
END CATCH