CREATE procedure [dbo].[st_AgentAddHistoryStatusNote]
(
    @IdAgent int,
    @IdAgentStatus int,
    @EnterByIdUser int,
...
begin catch       
    ...
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_AgentAddHistoryStatusNote',Getdate(),@ResultMessage)
end catch