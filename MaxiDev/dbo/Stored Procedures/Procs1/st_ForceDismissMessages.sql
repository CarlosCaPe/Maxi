/***************************/
/* st_ForceDismissMessages */
/***************************/
create Procedure [st_ForceDismissMessages]
(
...
Begin Catch
	...
	Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_ForceDismissMessages',Getdate(),@ErrorMessage)
End Catch