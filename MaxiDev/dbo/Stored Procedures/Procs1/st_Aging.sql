...
Select IdAgent,AgentName,AgentCode from Agent where IdAgentStatus in (1,3,4,7)    
...
Begin    
 ...
 DateOfMovement<@StartDate and DateOfMovement>@FromDate10 and  TypeOfMovement <>'DEP'   
...
Select AgentName,AgentCode,SUM(CurrentBalance) as CurrentBalance,SUM(Last10) as Last10,SUM(last30) as Last30,SUM(Last60) as Last60,SUM(Last90)  as Last90, @Older as Older   Into #result from #temp    
Group by AgentName, AgentCode  
order by AgentCode  
...
Select AgentName,AgentCode,Last10,Last30,Last60,Last90,Older,CurrentBalance from #result
