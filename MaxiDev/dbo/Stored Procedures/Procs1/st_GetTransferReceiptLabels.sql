CREATE PROCEDURE [dbo].[st_GetTransferReceiptLabels]
(
	@IdTransfer INT
)
AS
...
<Author></Author>
<app>MaxiAgent</app>
<Description>This stored is used to get labels for thermal ticket</Description>
...
<ChangeLog>
	...
	<log Date="03/02/2023" Author="maprado">BM-810 Fix para renombrar etiquete de telefono si es Asia</log>
</ChangeLog>
*********************************************************************/
BEGIN
	DECLARE @ReceiptPrefix VARCHAR(200) = 'Receipt.MT.'
