CREATE PROCEDURE [dbo].[st_BulkFaxInsertReportExchageRate]  
(  
...
Begin Catch                                        
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_BulkUpdateStatusForCompliance',Getdate(),@ErrorMessage)                                        
End Catch
