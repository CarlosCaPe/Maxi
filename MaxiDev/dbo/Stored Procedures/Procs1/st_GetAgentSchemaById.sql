...
<ChangeLog>
<log Date="16/11/2018" Author="smacias"> Creado </log>
<log Date="25/11/2019" Author="jzuniga"> Cambio de ordenamiento 4,7 a IdPayer, IdPaymentType </log>
</ChangeLog>

*********************************************************************/
CREATE procedure [dbo].[st_GetAgentSchemaById]
(
	@idAgentSchema int
)
as
