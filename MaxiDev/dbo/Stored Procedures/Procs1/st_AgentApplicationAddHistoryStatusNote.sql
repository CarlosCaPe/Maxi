CREATE procedure [dbo].[st_AgentApplicationAddHistoryStatusNote]
(
...
begin catch
    ...
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_AgentApplicationAddHistoryStatusNote',Getdate(),@ErrorMessage)
end catch