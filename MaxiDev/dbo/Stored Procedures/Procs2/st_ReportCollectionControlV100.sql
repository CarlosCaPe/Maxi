CREATE procedure [dbo].[st_ReportCollectionControlV100]  
@BeginDate datetime,                        
@EndDate datetime                        
as                        
...
(                        
 ...
 Insert into  @tResult (IdAgent,Agent,AgentStatus,IdAgentStatus,AgentPhone,ACHWellsFargo,BankName,AgentOrder,IdAgentPaymentSchema)                
 Select IdAgent,Agent,AgentStatus,IdAgentStatus,AgentPhone,case (IdAgentCollectType) when 1 then 'ACH' when 2 then 'ACH with Scanner' else 'Deposit' end,BankName,AgentOrder,IdAgentPaymentSchema from #agentTemp                
