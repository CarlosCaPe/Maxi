...
CREATE PROCEDURE [dbo].[st_StatusBeneficiarySAR]
...
BEGIN
    ...
    -- 
		...
		BEGIN CATCH					  
						 ...
						 -----------
						 INSERT INTO ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage) VALUES('[st_StatusBeneficiarySAR]',GETDATE(),@ErrorMessage) 
