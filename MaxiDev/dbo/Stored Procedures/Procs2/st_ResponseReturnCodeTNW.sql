CREATE procedure [dbo].[st_ResponseReturnCodeTNW]                                        
(                                        
    @IdGateway  int,
...
BEGIN TRY   
	...
	Insert into TNWResponseLog values (getdate(),@Claimcode,@ReturnCode,@ReturnCodeType,@IdStatusAction,@Description,@XmlValue)
	...
	-- Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_ResponseReturnCodeTNW',Getdate(),@ErrorMessage)                                                                                            
	--End Catch  
