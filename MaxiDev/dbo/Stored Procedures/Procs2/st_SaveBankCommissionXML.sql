--<BankCommissions xmlns="">
--   <BankCommission>
--     <Date>03/01/2014 15:44:11</Date>
--     <OldValue>0.018</OldValue>
--     <NewValue>2</NewValue>
--   </BankCommission>
--</BankCommissions>


CREATE PROCEDURE [dbo].[st_SaveBankCommissionXML]
(
    @BankCommission xml,
    @IdUser int,
...
while exists (select top 1 1 from #BankCommission)
    ...
    exec st_SaveBankCommission @DateOfBankCommission,@IdUser,@OldValue,@NewValue
...
Begin Catch
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_SaveBankCommissionXML',Getdate(),ERROR_MESSAGE())    
End Catch
