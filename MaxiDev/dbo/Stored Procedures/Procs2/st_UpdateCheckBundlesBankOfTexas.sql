...
*/
-- =============================================
CREATE PROCEDURE [dbo].[st_UpdateCheckBundlesBankOfTexas]
@BundlesXml XML,
...
BEGIN CATCH
	...
	INSERT INTO [dbo].[ErrorLogForStoreProcedure] ([StoreProcedure], [ErrorDate], [ErrorMessage]) VALUES('st_UpdateCheckBundlesBankOfTexas', GETDATE(), @ErrorMessage)
END CATCH
