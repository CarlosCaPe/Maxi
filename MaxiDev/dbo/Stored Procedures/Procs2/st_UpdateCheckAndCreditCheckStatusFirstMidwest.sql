...
<Description>This stored is used by fistmidwest bank in windows service to update check and credit check status </Description>
<ChangeLog>
<log Date="08/15/2016" Author="Mhinojo"> Creación </log>
</ChangeLog>
*********************************************************************/
CREATE PROCEDURE [dbo].[st_UpdateCheckAndCreditCheckStatusFirstMidwest]
@IdStatus INT,
@ChecksXml XML,
@CheckCreditXml XML,
...
BEGIN CATCH
	...
	INSERT INTO [dbo].[ErrorLogForStoreProcedure] ([StoreProcedure], [ErrorDate], [ErrorMessage]) VALUES('st_UpdateCheckAndCreditCheckStatusFirstMidwest', GETDATE(),@ErrorMessage)
END CATCH
