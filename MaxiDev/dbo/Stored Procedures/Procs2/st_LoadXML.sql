...
CREATE procedure [dbo].[st_LoadXML]         
as        
Set nocount on       
...
SET @fileName = 'H:\BozData\Softgate\Catalog\Products.xml'; /*2016-Oct-07*/
...
select 'st_FillBillers'
        
exec st_FillBillers    

select 'st_ProductsByProviderUpdater'

exec st_ProductsByProviderUpdater    

select 'LogSoftgateLoadXML'
