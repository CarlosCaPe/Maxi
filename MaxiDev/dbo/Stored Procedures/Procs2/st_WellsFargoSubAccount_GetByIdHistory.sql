...
CREATE PROCEDURE [dbo].[st_WellsFargoSubAccount_GetByIdHistory]
	@idReport int
AS
	/********************************************************************
		...
		[isAgent]
		 ...
		 AS ( 
				SELECT 
					...
					b.[isAgent]
				FROM AgentsReportWellsFargo a
				INNER JOIN AgentsReportWellsFargoDetail b ON b.IdAgentsReportWellsFargo = a.IdAgentsReportWellsFargo
				INNER JOIN Agent ag ON ag.IdAgent = b.idAgent
				INNER JOIN AgentStatus asts ON asts.IdAgentStatus = ag.IdAgentStatus
				...
				FROM AgentsReportWellsFargo a
				INNER JOIN AgentsReportWellsFargoDetail b ON b.IdAgentsReportWellsFargo = a.IdAgentsReportWellsFargo
				INNER JOIN AgentApplications ag ON ag.IdAgentApplication = b.idAgent
