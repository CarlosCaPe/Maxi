CREATE PROCEDURE [dbo].[st_UpdateCustomerInformation]
(
    @IdCustomer INT = 0,
...
BEGIN CATCH
	...
	INSERT INTO [dbo].[ErrorLogForStoreProcedure] ([StoreProcedure], [ErrorDate], [ErrorMessage]) VALUES('st_UpdateCustomerInformation', GETDATE(), @ErrorMessage)
	SET @HasError=1	
END CATCH
