create procedure [dbo].[st_ReportProfitByGateway]
(
...
Insert into #TempAgents (IdAgent)
	...
	where DateOfTransfer>@StartDate and DateOfTransfer<@EndDate and idgateway=@idgateway
	...
	Select IdAgent from TransferClosed  with (nolock)
	--where IdCountryCurrency= case when @IdCountryCurrency=0 Then IdCountryCurrency Else @IdCountryCurrency End 
	where DateStatusChange>@StartDate and DateStatusChange<@EndDate and IdStatus in (31,22) and idgateway=@idgateway
	...
	Select IdAgent from Transfer  with (nolock)
	--where IdCountryCurrency= case when @IdCountryCurrency=0 Then IdCountryCurrency Else @IdCountryCurrency End 
	where DateStatusChange>@StartDate and DateStatusChange<@EndDate and IdStatus in (27) and idgateway=@idgateway
	...
	IdAgent in (Select IdAgent from #TempAgents)  and idgateway=@idgateway
	...
	IdStatus=31  and idgateway=@idgateway
    ...
    DateStatusChange>@StartDate and
    DateStatusChange<@EndDate and
	IdStatus=22  and idgateway=@idgateway
	...
	T.IdStatus=22  and idgateway=@idgateway
    ...
    DateStatusChange>@StartDate and
    DateStatusChange<@EndDate and
	IdStatus=27  and idgateway=@idgateway
