CREATE procedure [dbo].[st_ResponseReturnCodeCITI]                                        
(                                        
    @IdGateway  int,                                        
...
BEGIN TRY
	...
	Insert into [MAXILOG].[dbo].CITIResponseLog values (getdate(),@Claimcode,@ReturnCode,@ReturnCodeType,@IdStatusAction,@Description,@XmlValue)                
	...
	---- La siguiente validación es por un caso de Cancel in progress  a PaymentReady,,con lo siguiente lo evitamos                 
	...
	Begin                                      
		...
		begin                                     
			...
			Begin
				exec st_SavePayInfoCITI @IdGateway,@IdTransfer,@Claimcode,@XmlValue
			End   
	...
	-- Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_ResponseReturnCodeCITI',Getdate(),@ErrorMessage)
	--End Catch                                
		End 
