CREATE PROCEDURE [dbo].[st_SaveCommission]
(
    @IdCommission int,
...
begin
    ...
    update pretransfer set isvalid=1 where idagentschema in(
...
BEGIN CATCH
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_SaveCommission',Getdate(),@ErrorMessage)    
END CATCH
