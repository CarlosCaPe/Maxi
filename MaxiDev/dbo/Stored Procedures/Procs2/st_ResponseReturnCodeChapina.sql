...
CREATE procedure [dbo].[st_ResponseReturnCodeChapina]                                      
(                                      
    @IdGateway  int,                                      
...
Insert into  ChapinaResponseLog values (getdate(),@Claimcode,@ReturnCode,@ReturnCodeType,@IdStatusAction,@Description,@XmlValue)              
...
Begin
	...
	begin
		...
		Begin
            exec st_SavePayInfoChapina @IdGateway,@IdTransfer,@Claimcode,@XmlValue
        End
