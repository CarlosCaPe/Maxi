create procedure [dbo].[st_SavePayerConfigCommission]
(
    @idpayerconfig int,    
...
End Try
Begin Catch 
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_SavePayerConfigCommission',Getdate(),ERROR_MESSAGE())    
End Catch