CREATE PROCEDURE [dbo].[st_UpdateCheckMicr]
(
	@IdCheck INT, 
...
BEGIN
	BEGIN TRY
		...
		Exec Checks.[st_SaveChangesToCheckLog] @IdCheck,60,'Duplicate Checks Validation on Update MICR',0
		...
		BEGIN
			SET @isDuplicate = 1;
			Exec Checks.[st_SaveChangesToCheckLog] @IdCheck,61,'Duplicated Check MICR on Update MIRC ',0
		END					
