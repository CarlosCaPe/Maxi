...
<Description>	This stored is used in wells fargo windows service, update check bundles and add note check file </Description>
...
*********************************************************************/
CREATE PROCEDURE [dbo].[st_UpdateCheckBundlesBankOfTexasNV]
@BundlesXml XML,
...
BEGIN CATCH
	...
	INSERT INTO [dbo].[ErrorLogForStoreProcedure] ([StoreProcedure], [ErrorDate], [ErrorMessage]) VALUES('st_UpdateCheckBundlesBankOfTexasNV', GETDATE(), @ErrorMessage);
END CATCH
