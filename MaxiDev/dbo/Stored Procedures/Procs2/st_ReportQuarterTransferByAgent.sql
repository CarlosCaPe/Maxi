 ...
 CREATE procedure [dbo].[st_ReportQuarterTransferByAgent]
(  
@Year int,   
@Quarter int  
)  
...
exec st_TotalTransferByMonth @Year, @Month1;  
  
Insert into #Results2  
exec st_TotalTransferByMonth @Year, @Month2;  
  
Insert into #Results3  
exec st_TotalTransferByMonth @Year, @Month3;  
