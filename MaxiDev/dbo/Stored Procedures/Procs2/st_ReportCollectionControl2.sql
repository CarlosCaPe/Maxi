create procedure [dbo].[st_ReportCollectionControl2]                      
@BeginDate datetime,                      
@EndDate datetime                      
as                      
...
(                      
 ...
 Select IdAgent,Agent,AgentStatus,IdAgentStatus,AgentPhone,case (ACHWellsFargo) when 1 then 'ACH' else 'Deposit' end,BankName,AgentOrder from #agentTemp              
