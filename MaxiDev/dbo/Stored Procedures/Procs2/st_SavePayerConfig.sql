CREATE procedure [dbo].[st_SavePayerConfig]      
@IdPayerConfig int,      
@IdPayer int,      
@IdGateway int,      
@IdPaymentType int,      
...
<log Date="28/07/2020" Author="jgomez">Se agrega el campo BenCellPhoneIsRequired en update a PayerConfig -- CR -M00242</log>
<log Date="31/08/2020" Author="adominguez">Se agrega el campo BranchCodeIsRequired en update a PayerConfig -- CR -M00244</log>
</ChangeLog>
********************************************************************/
