...
CREATE PROCEDURE [dbo].[st_StatusCustomerSAR]
		...
		BEGIN CATCH					  
					 DECLARE @ErrorMessage NVARCHAR(MAX)         
 					  SELECT @ErrorMessage=ERROR_MESSAGE()        
						 ...
						 -----------
					  INSERT INTO ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage) VALUES('[st_StatusCustomerSAR]',GETDATE(),@ErrorMessage) 
