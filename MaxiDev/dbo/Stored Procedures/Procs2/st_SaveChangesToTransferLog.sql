...
CREATE PROCEDURE [dbo].[st_SaveChangesToTransferLog]
(
@IdTransfer INT,
@IdStatus INT,
@Note NVARCHAR(MAX),
...
BEGIN TRY
	...
	EXEC [dbo].[st_InsertSmsFromStatusChange] @IdTransfer, @IdStatus
...
BEGIN CATCH
	...
	INSERT INTO [dbo].[ErrorLogForStoreProcedure] ([StoreProcedure], [ErrorDate], [ErrorMessage]) VALUES ('st_SaveChangesToTransferLog', GETDATE(), @ErrorMessage)
END CATCH
