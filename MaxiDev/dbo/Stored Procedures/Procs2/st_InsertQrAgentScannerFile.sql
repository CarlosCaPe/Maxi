CREATE PROCEDURE [dbo].[st_InsertQrAgentScannerFile]
(
    @Id INT,
...
SELECT * FROM dbo.AgentCollectType with(nolock)
...
BEGIN CATCH
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_InsertQrAgentScannerFile',Getdate(),@ErrorMessage)    
END CATCH