...
CREATE Procedure [dbo].[st_SpecialSaveOtherCharge]              
...
Begin Catch                                    
 ...
 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_SpecialSaveOtherCharge',Getdate(),@ErrorMessage)                                    
End Catch
