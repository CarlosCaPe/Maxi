...
CREATE procedure [dbo].[st_ReportCollectionControlWithoutFinalStatus]  
@BeginDate datetime,                        
@EndDate datetime                        
as                        
 ...
 */
 ...
 left join AgentBankDeposit D with(nolock) on A.IdAgentBankdeposit=D.IdAgentBankdeposit
 join agentstatus s2 with(nolock) on a.IdAgentStatus = s2.IdAgentStatus
