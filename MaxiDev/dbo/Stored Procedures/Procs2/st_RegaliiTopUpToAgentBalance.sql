CREATE Procedure [dbo].[st_RegaliiTopUpToAgentBalance]
(        
    @IdTransaction int,
    @IdOtherProduct int,
    @IdAgent int,
...
BEGIN
    ...
    values
    (@IdAgentBalance,@Amount,@CGS-@AgentCommission-@CorpCommission,@Fee,@ProviderFee, @CorpCommission);    
END
ELSE
BEGIN
    insert into agentbalancedetail
    values
    (@IdAgentBalance,@Amount,@CGS-@CorpCommission,@Fee,@ProviderFee, @CorpCommission);
END
