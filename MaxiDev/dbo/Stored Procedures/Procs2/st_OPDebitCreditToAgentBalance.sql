...
-- Description:	Register billpayment operation for agent balance
-- =============================================
CREATE PROCEDURE [dbo].[st_OPDebitCreditToAgentBalance]
...
BEGIN TRY
	...
	SELECT @IsMonthly = CASE WHEN [IdAgentPaymentSchema] = 1 THEN 1 ELSE 0 END FROM [dbo].[Agent] WHERE [IdAgent] = @idAgent
                   
	IF NOT EXISTS (SELECT TOP 1 1 FROM [dbo].[AgentCurrentBalance] WHERE [IdAgent] = @IdAgent)
