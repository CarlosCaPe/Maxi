CREATE  procedure [dbo].[st_ResponseReturnCodeCibanco]                                
(                                
    @IdGateway  int,                                
...
--where IdGateway=@IdGateway And IdGatewayReturnCodeType=@ReturnCodeType And ReturnCode=@ReturnCode --#1
                            
Insert into [MAXILOG].[dbo].CibancoResponseLog values (getdate(),@Claimcode,@ReturnCode,@ReturnCodeType,@IdStatusAction,@Description,@XmlValue)                          
...
Begin                                              
	...
	begin                                             
		...
		Begin
            exec st_SavePayInfoCibanco @IdGateway,@IdTransfer,@Claimcode,@XmlValue
        End
...
-- Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_ResponseReturnCodeCibanco',Getdate(),@ErrorMessage)                                                                                            
--End Catch  
	End   
