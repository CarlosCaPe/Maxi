...
-- =============================================
CREATE PROCEDURE [dbo].[st_UpdateCheckAndCreditCheckStatusBankOfTexas]
@IdStatus INT,
@ChecksXml XML,
@CheckCreditXml XML
AS
...
BEGIN CATCH
	...
	INSERT INTO [dbo].[ErrorLogForStoreProcedure] ([StoreProcedure], [ErrorDate], [ErrorMessage]) VALUES('st_UpdateCheckAndCreditCheckStatusBankOfTexas', GETDATE(),@ErrorMessage)
END CATCH
