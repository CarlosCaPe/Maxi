create procedure st_UpdateAgentForCollectionPaymentSchema
(
    @IdLenguage int,
    @EnterByIdUser int,
    @IdAgent int,
...
Begin Catch                                                                                        
    ...
    Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('st_UpdateAgentForCollectionPaymentSchema',Getdate(),@ErrorMessage)                                                                                            
End Catch