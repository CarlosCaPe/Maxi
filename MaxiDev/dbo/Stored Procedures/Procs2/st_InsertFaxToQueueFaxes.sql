...
CREATE PROCEDURE [dbo].[st_InsertFaxToQueueFaxes]
(
    @Parameters XML,
...
Begin Catch
		 ...
		 Insert into ErrorLogForStoreProcedure (StoreProcedure,ErrorDate,ErrorMessage)Values('[st_InsertFaxToQueueFaxes]',Getdate(),@ErrorMessage) 
         set @HasError =1
