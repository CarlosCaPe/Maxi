...
<Description>	This stored is used in southside windows service, update check bundles and add note check file  </Description>
...
*********************************************************************/
CREATE PROCEDURE [dbo].[st_UpdateCheckBundlesSouthSideNV]
@BundlesXml XML,
